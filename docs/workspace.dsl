...
workspace "${SERVICE_NAME}" "Mozilla's service providing email and phone masks." {
    ...
    model {
        ...
        email_contact -> email_receiver "Sends email" "Internet Mail System / SMTP"
        ...
        email_sender -> user "Forwards email" "Internet Mail System / SMTP"
        email_sender -> email_contact "Sends replies" "Internet Mail System / SMTP"
    ...
    views {
        ...
        dynamic relay forward_process "ForwardEmailProcess" {
            ...
            email_contact -> email_receiver "Sends email. Email passes DMARC, virus, and spam checks" "Internet Mail System / SMTP"
            {
                {
