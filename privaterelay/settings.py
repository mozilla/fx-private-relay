...
PROCESS_EMAIL_LOG_FAILED_MESSAGES = config(
    "PROCESS_EMAIL_LOG_FAILED_MESSAGES", False, cast=bool
)
PROCESS_EMAIL_LOG_FAILED_MESSAGES_SIZE = config(
    "PROCESS_EMAIL_LOG_FAILED_MESSAGES", 20 * 1024, cast=int
)
