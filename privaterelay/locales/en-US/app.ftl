...
profile-label-trackers-blocked = Trackers Blocked
profile-label-trackers-identified = Trackers Found
...
profile-trackers-blocked-copy = Email trackers that identify email being opened has been blocked while relaying to your email.
profile-trackers-identified-copy = Email trackers that track clicks inside the email has been identified while relaying your email.
