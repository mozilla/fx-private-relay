...
AUTOGENERATED BY glean_parser v18.1.0. DO NOT EDIT. To recreate, run:
...
class EventsServerEventLogger:
    ...
    def record(
        self, user_agent: str, ip_address: str, events: list[dict[str, Any]]
    ) -> None:
        now = datetime.now(UTC)
        timestamp = now.isoformat()
        for event in events:
            event["timestamp"] = int(
                1000.0 * now.timestamp()
        ...
        event_payload = {
            ...
            "client_info": {
                "telemetry_sdk_build": "glean_parser v18.1.0",
