...
CountryStr = Literal[
    ...
    "FR", "GB", "GR", "HR", "HU", "IE", "IT", "LT", "LU", "LV", "MT", "MY",
    "NL", "NZ", "PL", "PR", "PT", "RO", "SE", "SG", "SI", "SK", "US"
]
...
PlanCountryLangMapping = dict[CountryStr, dict[LanguageStr | Literal["*"], PlanPricing]]
...
def get_country_language_mapping(plan: PlanType) -> PlanCountryLangMapping:
...
def get_premium_countries() -> set[CountryStr]:
    ...
    return get_supported_countries("premium") | get_supported_countries("phones") | get_supported_countries("bundle")
...
@lru_cache
def _cached_country_language_mapping(plan: PlanType) -> PlanCountryLangMapping:
    ...
    for country in _get_supported_countries_by_plan(plan):
        ...
        mapping[country] = {
            "*": {
                "monthly": {
                    "price": prices["monthly"], "currency": currency
                },
                "yearly": {
                    "price": prices["yearly"], "currency": currency
                },
            }
        }
...
def _get_supported_countries_by_plan(plan: PlanType) -> list[CountryStr]:
    ...
    plan_countries: dict[PlanType, list[CountryStr]] = {
        "premium": ["AT", "BE", "BG", "CA", "CH", "CY", "CZ", "DE", "DK", "EE", "ES", "FI", "FR", "GB", "GR",
                    "HR", "HU", "IE", "IT", "LT", "LU", "LV", "MT", "MY", "NL", "NZ", "PL", "PR", "PT", "RO",
                    "SE", "SG", "SI", "SK", "US"],
        "phones": ["US", "CA", "PR"],
        "bundle": ["US", "CA", "PR"],
    }
...
def _get_country_currency(country: CountryStr) -> CurrencyStr:
    ...
    country_currency_map: dict[CountryStr, CurrencyStr] = {
        "AT": "EUR", "BE": "EUR", "BG": "EUR", "CA": "USD", "CH": "CHF", "CY": "EUR",
        "CZ": "CZK", "DE": "EUR", "DK": "DKK", "EE": "EUR", "ES": "EUR", "FI": "EUR",
        "FR": "EUR", "GB": "USD", "GR": "EUR", "HR": "EUR", "HU": "EUR", "IE": "EUR",
        "IT": "EUR", "LT": "EUR", "LU": "EUR", "LV": "EUR", "MT": "EUR", "MY": "USD",
        "NL": "EUR", "NZ": "USD", "PL": "PLN", "PR": "USD", "PT": "EUR", "RO": "EUR",
        "SE": "EUR", "SG": "USD", "SI": "EUR", "SK": "EUR", "US": "USD",
    }
