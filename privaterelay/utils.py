...
def flag_is_active_for_user(flag_name: str, user: AbstractBaseUser) -> bool:
    """
    Test if a flag is active for a user outside of a request.
    ...
    * Checks flag.users and flag.groups
