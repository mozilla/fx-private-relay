...
phone-onboarding-step4-code-success-subhead-body-p1 = { -brand-name-relay } sent you an text with a new contact card through which we’ll forward your calls and messages.
