...
bundle-banner-1-year-plan = 1 year plan: { -brand-name-firefox-relay-premium } + { -brand-name-mozilla-vpn }
bundle-price-monthly = Monthly: { $monthly_price }
bundle-price-save-amount = Save { $savings }
