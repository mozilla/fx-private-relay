...
export const PlusIcon2 = (props: SVGProps<SVGSVGElement> & { alt: string }) => {
  return (
    <svg
      width="24"
      height="24"
...
// Non-strong Close Icon from Nebula
export const CloseIconNormal = ({
  alt,
  ...props
}: SVGProps<SVGSVGElement> & { alt: string }) => {
  return (
