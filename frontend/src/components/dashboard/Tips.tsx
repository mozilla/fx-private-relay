    ...
    <aside className={styles.wrapper}>
      <div className={styles.card}>
        <header className={styles.header}>
          ...
          <h2>
            {l10n.getString("tips-header-title")}
          </h2>
          <button onClick={() => dismissal.dismiss()} className={styles.closeButton}>
            <CloseIcon alt={l10n.getString("tips-header-button-close-label")} width={20} height={20}/>
          </button>
        </header>
        ...
        <footer className={styles.footer}>
          <ul>
            <li>
              <Link href="/faq">
                <a title={l10n.getString("tips-footer-link-faq-tooltip")}>{l10n.getString("tips-footer-link-faq-label")}</a>
              </Link>
            </li>
            <li>
              <a
...
const CustomAliasTip = (props: CustomAliasTipProps) => {
  ...
  return (
    <div className={styles.customAliasTip}>
      ...
      <h3>
        {l10n.getString("tips-custom-alias-heading")}
      </h3>
      <p>
        {l10n.getString("tips-custom-alias-content")}
      </p>
    </div>
  );
};
