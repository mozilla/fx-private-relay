...
function getFxAppLinkInfo(localizedBentoStrings, referringSiteURL) {
  return [
    ...
    [localizedBentoStrings.fxVPN, `http://mozilla.org/firefox/mobile?utm_source=${referringSiteURL}&utm_medium=referral&utm_campaign=bento&utm_content=desktop`, "fx-vpn"],
  ];
}
