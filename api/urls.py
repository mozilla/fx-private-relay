...
if settings.PHONES_ENABLED:
    ...
    urlpatterns += [
        ...
        path("v1/call/", enable_if_setting("PHONES_CALL_ENABLED")(call), name="call"),
        path(
            "v1/messages/",
            enable_if_setting("PHONES_CALL_ENABLED")(messages),
            name="messages",
        ),
        path(
            "v1/message/",
            enable_if_setting("PHONES_CALL_ENABLED")(post_message),
            name="post_message",
        ),
        path(
            "v1/sms_status",
